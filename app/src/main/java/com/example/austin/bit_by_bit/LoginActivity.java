...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /*public class TheAccessToken extends AccessToken {
        JSONObject token;

        public TheAccessToken() {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            /*userRepository.loginUser(mUsername, mPassword, new UserRepository.LoginCallback() {

                @Override
                public void onSuccess(AccessToken token, User currentUser) {

                    Log.d("asdsfa", token.getUserId().toString());
                }
            ...
            HttpPost httpPost = new HttpPost("http://4e91b6d8.ngrok.io/api/users/login");
